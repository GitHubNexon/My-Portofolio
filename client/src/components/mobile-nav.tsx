...
export default function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-4 left-0 right-0 mx-auto w-fit bg-[var(--background)] text-[var(--foreground)] p-3 rounded-full shadow-lg flex items-center space-x-2 md:hidden z-40">
      {/* Navigation Items */}
